...
public class ProcessServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(arr != null){
            for (Cookie o : arr) {
                if(o.getName().equals("cart")){
                    txt += o.getValue();
                    // if product already in cart then remove cookie, + quantity
                    o.setMaxAge(0);
        ...
        try{
            ...
            Product p = d.getProductId(id_raw);
        ...
        // Sau khi điều chỉnh thì cần lưu lại vào cookie
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 0; i < ids.length; i++) {
            ...
            //Lấy các sp không bị xóa(khác id ở trên)
            if(!s[0].equals(id)){
                if(out.isEmpty()){
                    out=ids[i];
                }else{
        ...
        // out tồn lại thì tạo cookie mới
        if(!out.isEmpty()){
