<%-- 
    Document   : cart
    Created on : Jun 19, 2023, 11:05:16 PM
    Author     : t
--%>
                        ...
                        <table class="table shopping-summery">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${c.items}" var="o">
                                    <tr>
                                        <td class="image" data-title="No"><img src="images/${o.product.image}" alt="#"></td>
                                        <td class="product-des" data-title="Description">
                                            <p class="product-name"><a href="#">${o.product.name}</a></p>
                                            <p class="product-des">${o.product.describe}</p>
                                        </td>
